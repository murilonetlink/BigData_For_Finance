...
def render_monitoring_page():
    ...
    if not df_auditoria.empty:
        ...
        def definir_cor(idx):
            return '1. Líder' if idx == 0 else '2. Vice' if idx == 1 else '3. Outros' df_viz['categoria_cor'] = [definir_cor(i) for i in range(len(df_viz))]
        
        mapa_cores = { '1. Líder': CORES_FAE['roxo'], '2. Vice': CORES_FAE['dourado'], '3. Outros': CORES_FAE['azul_esverdeado']
        }
        ...
        st.warning(" Nenhuma tabela encontrada. Rode o ETL.")